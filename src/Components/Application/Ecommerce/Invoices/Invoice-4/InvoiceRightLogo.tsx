...
const InvoiceRightLogo = () => {
  return (
    <td>
      <Image width={106} height={37} className="img-fluid for-light" src={`${ImagePath}/logo/logo.png`} alt="logo" style={{ height: "50px", marginBottom: 14 }} unoptimized/>
      <Image width={106} height={37} className="img-fluid for-dark" src={`${ImagePath}/logo/dark-logo.png`} alt="logo" style={{ height: "50px", marginBottom: 14 }} unoptimized/>
