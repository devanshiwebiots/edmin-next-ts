          ...
          <div className="scroll-bar-wrap">
            <ScrollBar className="scroll-demo" style={{width:"100%", height:"300px"}}>
              <div className="horz-scroll-content scroll-content-width">
                <Row>
                  <Col sm="3">
                    <div className="visible-wrapper"><Image width={330} height={330} src={`${ImagePath}/banner/2.jpg`} alt="office-work" unoptimized/></div>
                  ...
                  <Col sm="3">
                    ...
                    <div className="visible-wrapper"><Image width={330} height={330}  src={`${ImagePath}/email/3.jpg`} alt="office" unoptimized/></div>
                  </Col>
                  <Col sm="3">
                  ...
                  <Col sm="3">
                    ...
                    <div className="visible-wrapper"><Image width={330} height={330}  src={`${ImagePath}/banner/3.jpg`} alt="website" unoptimized/></div>
