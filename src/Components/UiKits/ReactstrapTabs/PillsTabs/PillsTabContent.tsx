      ...
      <TabPane tabId="3">
        <div className="pt-3 d-flex align-items-center gap-3 pills-blogger">
          <div className="blog-wrapper d-flex bg-light-primary">
            <div className="flex-shrink-0 border-primary"><Image width={22} height={22} className="blog-img" src={`${ImagePath}/dashboard2/product/1.png`} alt="head-phone" unoptimized/></div>
          </div>
        ...
        <div className="pt-3 d-flex align-items-center gap-3 pills-blogger">
          <div className="blog-wrapper d-flex bg-light-secondary">
            <div className="flex-shrink-0 border-secondary"><Image width={22} height={22} src={`${ImagePath}/dashboard2/product/2.png`} alt="product" unoptimized/></div>
          </div>
          <div className="blog-content">
